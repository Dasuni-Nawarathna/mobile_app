                ...
                action={
                    <div className="flex items-center gap-2">
                        <Link
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg bg-white/[0.04] border border-white/[0.08] text-white/60 hover:text-antique-gold hover:border-antique-gold/30 hover:bg-antique-gold/[0.06] transition-colors"
                        >
                            Invoices
                        </Link>
                        <Link
