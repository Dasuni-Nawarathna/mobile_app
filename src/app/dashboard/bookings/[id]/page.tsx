...
import { ArrowLeft, CalendarCheck, CreditCard, Car, Users, FileText, History, Plus, Trash2 } from "lucide-react";
...
import DeleteBookingButton from "@/components/dashboard/bookings/DeleteBookingButton";
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <Link
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg bg-antique-gold/10 border border-antique-gold/20 text-antique-gold hover:bg-antique-gold/20 transition-colors"
                    >
                        <Plus className="h-3.5 w-3.5" /> New Booking
                    </Link>
                    {(userRole === 'ADMIN' || userRole === 'STAFF') && (
                        <DeleteBookingButton bookingId={String(booking._id)} bookingNo={booking.bookingNo} />
                    )}
                </div>
            </div>
